...
## Prerequistes
Strong programming in **one** of (Python, R, Julia, Matlab). Comfortable with linear algebra and basic probabilty. Please do not worry if you don't have a background in biology. Any relevant concepts will be introduced. Please feel free to talk to me about any of these prerequistes. 
