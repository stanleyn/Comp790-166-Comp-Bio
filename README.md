...
| Week 4-2 | Single Cell Day 1: Intro to single-cell proteomics, visualization, normalization and batch effect correction | |
|Week 5-1 | Single Cell Day 2: Graph-based analysis of single-cell data | |
| Week 5-2 | Single Cell Day 3: Feature Engineering from single-cell data and linking to external variables |
| Week 6-1| Single Cell Day 4: Differential Analysis of Cell-Populations | |
| Week 6-2 | Single Cell Day 5: Deep Learning in Single-Cell Analysis | |
| Week 7-1 | Single Cell Day 6: Trajectory Inference | |
| Week 7-2 : Project Proposals Due | Presentations of Project Propsals Day 1 | |
| Week 8-1 | Project Proposal Presentation Day 2 | |
| Week 9-1| Single Cell Day 7: Benchmarking in Single-Cell Analysis | |
| Week 8-2 | Single Cell Day 8: Imaging Proteomics + Spatial Regularization : computational challeneges in combining tissue images and protein expression | |
